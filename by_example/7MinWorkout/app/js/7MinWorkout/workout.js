...
angular.module('7minWorkout').controller('WorkoutController', ['$scope', '$interval', '$location',  WorkoutController]);
...
function WorkoutController($scope, $interval, $location) {
    ...
    var createWorkout = function () {
        ...
        var defaultRestDuration = 3;
        var defaultExerciseDuration = 5;

        var workout = new WorkoutPlan({
            name: "7minWorkout",
            title: "7 Minute Workout",
            restBetweenExercise: defaultRestDuration
        });
